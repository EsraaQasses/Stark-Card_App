        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-6 rounded-2xl md:w-780">
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-gray-500 text-sm">Real-time financial overview</p>
            </div>
          ...
          <div className="mt-6 flex gap-8 flex-wrap justify-center">
            <div className="border-r-1 border-color m-4 pr-8">
              <div className="mb-6">
                <p>
                  <span className="text-3xl font-semibold">${stats.totalRevenue.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-6 rounded-2xl md:w-96">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              <span className="text-blue-600 dark:text-blue-300 font-medium">Shipping Requests</span>
            ...
            <div className="flex justify-between items-center p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
              <span className="text-yellow-600 dark:text-yellow-300 font-medium">Pending Reviews</span>
            ...
            <div className="flex justify-between items-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
              <span className="text-green-600 dark:text-green-300 font-medium">In Progress</span>
            ...
            <div className="flex justify-between items-center p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
              <span className="text-orange-600 dark:text-orange-300 font-medium">Objections</span>
