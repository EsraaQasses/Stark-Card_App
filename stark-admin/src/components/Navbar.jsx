...
import { FaWallet, FaUser, FaUserShield } from 'react-icons/fa';
  ...
  return (
    <div className="flex justify-between p-2 md:ml-6 md:mr-6 relative">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Profile Button - Direct navigation to profile page */}
        {/* <TooltipComponent content="My Profile" position="BottomCenter">
          <button
            type="button"
            onClick={handleProfileClick}
            className="relative text-xl rounded-full p-3 hover:bg-light-gray text-blue-500 hover:text-blue-600 transition-colors"
            title="My Profile"
          >
            <FaUser />
          </button>
        ...
        {/* User Info Display - Click to go to profile */}
