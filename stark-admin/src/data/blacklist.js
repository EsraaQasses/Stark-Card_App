...
const customerGridImage = (props) => (
  <div className="image flex gap-3 items-center">
    <img
    ...
    />
    <div>
      <p className="font-semibold text-gray-800 dark:text-gray-100">{props.CustomerName}</p>
      <p className="text-xs text-gray-500 dark:text-gray-400">{props.CustomerEmail}</p>
    </div>
  </div>
);
