    ...
    <View style={styles.root}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.body}>
          ...
          <Botton variant="auth" title="By Email" onPress={() => navigation.navigate("Email")} width={sx(330)} height={sy(60)} />
          <Botton variant="auth" title="By Phone Number" onPress={() => navigation.navigate("Phone")} width={sx(330)} height={sy(60)} />
          <Botton variant="auth" title="By Google" onPress={() => {}} width={sx(330)} height={sy(60)} />
        </View>
